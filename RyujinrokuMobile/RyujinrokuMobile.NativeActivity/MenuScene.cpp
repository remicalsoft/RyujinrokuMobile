...
MenuScene::MenuScene(shared_ptr<Context> context, IOnSceneChangedListener* impl, const Parameter& parameter) : AbstractScene(context, impl, parameter)
{
    ...
    _rightParticleMgr = make_shared<RightParticleMgr>(_context);
    _shineLineMgr = make_shared<ShineLineMgr>();
}
...
void MenuScene::draw() const
{
    ...
    _rightParticleMgr->draw();
    _shineLineMgr->draw();
}

void MenuScene::onClick(View* view)
{
}
